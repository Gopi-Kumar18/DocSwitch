...
const PdfToJpg = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('conversionType', 'pdf-to-jpg');
  ...
  return (
    <>
    <div className="pdf-to-jpg container mt-5">
      <h2 className="text-center mb-4">PDF to JPG</h2>
  ...
  <h4 className="mb-4">
    How to convert documents with the DocSwitch PDF to JPG converter tool
  </h4>
  <p className="mb-4">
  ...
  <div className="d-flex justify-content-center">
    <ol className="list-group list-group-numbered text-start" style={{ maxWidth: "600px", width: "100%" }}>
      ...
      <li className="list-group-item">
        Our tool will automatically convert the PDF to an uneditable JPG Format.
      </li>
      <li className="list-group-item">
        After conversion, download the JPG image or share it as needed.
      </li>
    </ol>
  </div>
</div>
