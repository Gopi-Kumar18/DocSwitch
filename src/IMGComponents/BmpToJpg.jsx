...
const BmpToJpg = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('conversionType', 'bmp-to-jpg');
  ...
  return (
    <>
    <div className="bmp-to-jpg container mt-5">
      <h2 className="text-center mb-4">BMP to JPG</h2>
...
<div className="container mt-5 mb-5 text-center">
  <h4 className="mb-4">
    How to convert BMP images using the DocSwitch BMP to JPG converter tool
  </h4>
  <p className="mb-4">
    Follow these quick steps to change a BMP file into a standard JPG image:
  </p>

  <div className="d-flex justify-content-center">
    <ol className="list-group list-group-numbered text-start" style={{ maxWidth: "600px", width: "100%" }}>
      <li className="list-group-item">
        Click the <strong>"Choose File"</strong> button or drag and drop your BMP file.
      </li>
      <li className="list-group-item">
        Pick the BMP image you want to convert.
      </li>
      <li className="list-group-item">
        The tool will quickly convert your BMP into a compressed JPG format.
      </li>
      <li className="list-group-item">
        Once processed, download the JPG image to your device.
      </li>
    </ol>
  </div>
</div>
