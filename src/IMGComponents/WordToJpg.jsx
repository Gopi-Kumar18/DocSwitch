...
const WordToJpg = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('conversionType', 'word-to-jpg');
  ...
  return (
    <>
    <div className="word-to-jpg container mt-5">
      <h2 className="text-center mb-4">Word to JPG</h2>
      <div className="card shadow mx-auto" style={{ maxWidth: '500px' }}>
        <div className="card-body">
         ...
         {isLoading ? (<span className="converting-shimmer">Converting...</span>) : ("Convert to JPG")}
            </button>
            </div>
...
<div className="container mt-5 mb-5 text-center">
  <h4 className="mb-4">
    How to convert Word documents using the DocSwitch Word to JPG converter tool
  </h4>
  <p className="mb-4">
    Follow these easy steps to turn a Microsoft Word document into JPG images:
  </p>

  <div className="d-flex justify-content-center">
    <ol className="list-group list-group-numbered text-start" style={{ maxWidth: "600px", width: "100%" }}>
      <li className="list-group-item">
        Click the <strong>"Choose File"</strong> button or drag and drop your Word (.doc or .docx) file.
      </li>
      <li className="list-group-item">
        Select the Word document you want to convert to JPG.
      </li>
      <li className="list-group-item">
        Our tool will instantly convert your Word pages into high-quality JPG images.
      </li>
      <li className="list-group-item">
        After conversion, download each image or share them as needed.
      </li>
    </ol>
  </div>
</div>
