...
export const splitPdf = async (req, res) => {
  ...
  try {
    ...
    // 3. Read desired page count (default to 2)
    const pageCount = parseInt(req.body.pageCount, 10) || 2;

    // 4. Adobe credentials + client
    ...
    // 9. Iterate through each resulting asset
    ...
    // remove any outputs that may have been written
